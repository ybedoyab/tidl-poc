...
Over 1 s, 20 ps is 2×10⁻¹¹ fractional frequency. That allocation belongs to the
10 MHz source, distribution, and traceability chain. Methodology: NIST SP 1065
and IEEE 1139. This repository has no ADEV dataset.
